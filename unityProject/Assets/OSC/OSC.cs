...
//{
  ...
  public class OSC : MonoBehaviour
  {
    ...
    void Awake() {
        // ***HACK*** - get settings from playerprefs instead of public vars
        inPort = PlayerPrefs.GetInt("ipPortListen");
        outIP = PlayerPrefs.GetString("ipAddressListen");
        outPort = PlayerPrefs.GetInt("ipPortTransmit");
